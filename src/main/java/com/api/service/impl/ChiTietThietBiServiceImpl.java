...
public class ChiTietThietBiServiceImpl implements ChiTietThietBiService {
    ...
    @Override
    public void xoaChiTietThietBi(String maThietBi) {
        List<ChiTietThietBiEntity> ctTB = chiTietThietBiRepository.findByCtThietBi_MaTB(maThietBi);
        for (ChiTietThietBiEntity e: ctTB) {
            chiTietThietBiRepository.deleteById(e.getIdCTTB());
        }
    }
}
